...
## Project Structure
    ...
    ├── testapiautosettings_86598  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_86598`
...
2. Clone this repo and `cd testapiautosettings_86598`
